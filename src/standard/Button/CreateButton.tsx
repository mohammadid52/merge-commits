...
const CreateButton = (props: ButtonProps ) => {
    ...
    return (
        ...
        <span className="w-40 flex inline-flex rounded-md shadow-sm">
            ...
            text-indigo-700 bg-white border-indigo-700 hover:bg-indigo-600 hover:border-none hover:bg-opacity-50 focus:border-indigo-800 focus:ring-indigo active:bg-indigo-800
