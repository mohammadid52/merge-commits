...
const Success = ({message = 'Successfully uploaded'}) => {
      ...
      <div className="flex">
        ...
        <div className="ml-auto pl-3 w-8" onClick={handleClick}>
          <div className="-mx-1.5 -my-1.5">
            <button
              className="flex justify-end rounded-md p-1.5 text-green-500 hover:bg-green-100 focus:outline-none focus:bg-green-100 transition ease-in-out duration-150"
              aria-label="Dismiss">
