    ...
    <div className="flex flex-col">
        <div className="-my-2 py-2">
            ...
            <div className="w-full flex justify-end">
                <span className="w-40 flex inline-flex rounded-md shadow-sm">
                    ...
                    text-indigo-700 bg-white border-indigo-700 hover:bg-indigo-600 hover:bg-opacity-50 hover:border-none focus:border-indigo-800 focus:ring-indigo active:bg-indigo-800
        ...
        data.length > 0 ? data.map((item: any, key: number) => (
                ...
                <tr>
                    ...
                    <td className="px-8 py-4 cursor-pointer whitespace-nowrap text-right border-b-0 border-gray-200 text-sm leading-5 font-medium" onClick={handleLink} >
