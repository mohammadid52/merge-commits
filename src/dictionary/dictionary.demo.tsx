...
const PreviewFormDict: any = {
  EN: {
    ...
    MESSAGES: {
      ...
      FETCHERR:
        "Error while fetching units for this lesson.Please try after some time.",
    },
    PREVIEW_DETAILS: {
      WARN_MESSAGE:
...
const InstitutionEditDict: any = {
  EN: {
    ...
    messages: {
      ...
      unabletoupdate:
        "Unable to update institute details. Please try again later.",
  ...
  EN: {
    ...
    MESSAGES: {
      ERROR: {
        ...
        designerlist:
          "Error while fetching Designers list Please try again later.",
        process: "Error while processing please Try again later.",
        invalid:
          "Invalid path please go back to institution selection page to select your institute.",
        FETCH_COURSE_ERR:
          "Error while fetching course data, please try again later.",
      ...
      validation: {
        ...
        curricular:
          "This course name is already exist, please add another name.",
      },
      success: {
  ...
  EN: {
    ...
    messages: {
      error: {
        ...
        institutelist:
          "Unable to fetch institution list. Please try again later.",
        ...
        process: "Error while processing please Try again later.",
        classroomadd:
          "Error while adding Classroom course. Please try again later.",
      ...
      validation: {
        ...
        classroomexist:
          "This Classroom name is already exist, please add another name.",
      },
      success: {
...
const RoomEDITdict: any = {
  EN: {
    ...
    messages: {
      ...
      errupdating:
        "Error while updating Classroom course. Please try that later.",
      errprocess: "Error while processing. Please try again later.",
      errupdatingclass:
        "Error while updating Classroom details. Please try again later.",
...
const EditProfileCheckpointDict: any = {
  EN: {
    ...
    messages: {
      ...
      onequetion:
        "You need to add minimum one question to create a checkpoint.",
...
const ProfileCheckpointlookupDict: any = {
  EN: {
    ...
    language: "Language",
    listempty:
      "Other checkpoint list is empty, please create a new checkpoint.",
...
const AddQuestionModalDict: any = {
  EN: {
    TITLE: "ADD QUESTION",
    HEADING:
      "*Click here to add Question, directly from previously created questions.",
    QUESTION: "Question",
    NOTELABEL: "Notes",
...
const AddNewLessonFormDict: any = {
  EN: {
    ...
    MESSAGES: {
      ...
      LESSONNOTHAVE:
        "This lesson does not have any measurements, please add new one.",
...
const AssessmentInstuctionsDict: any = {
  EN: {
    ...
    HEADING:
      "INSTRUCTIONS: Complete the following to provide information about your",
    SAVE: "Save",
    SAVING: "Saving...",
    MESSAGES: {
...
const LessonBuilderDict: any = {
  EN: {
    ...
    LEARNING_EVIDENCE_TOOLTIP:
      "Assign your lesson to courses in step 3 to continue",
    BUTTON: {
    ...
    MESSAGES: {
      ...
      PUBLISH_DISABLED_INFO:
        "Complete lesson summary and plan tabs to continue",
    },
