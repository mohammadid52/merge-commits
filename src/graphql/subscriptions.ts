...
`;
export const onCreateDicitionary = /* GraphQL */ `
  subscription OnCreateDicitionary(
    $filter: ModelSubscriptionDicitionaryFilterInput
  ) {
    onCreateDicitionary(filter: $filter) {
      id
      authID
      email
      person {
...
`;
export const onUpdateDicitionary = /* GraphQL */ `
  subscription OnUpdateDicitionary(
    $filter: ModelSubscriptionDicitionaryFilterInput
  ) {
    onUpdateDicitionary(filter: $filter) {
      id
      authID
      email
      person {
...
`;
export const onDeleteDicitionary = /* GraphQL */ `
  subscription OnDeleteDicitionary(
    $filter: ModelSubscriptionDicitionaryFilterInput
  ) {
    onDeleteDicitionary(filter: $filter) {
      id
      authID
      email
      person {
