...
export const standardTheme = {
  ...
  blockQuote:
    "px-4 border-l-4 border-white border-opacity-50 bg-black bg-opacity-40",
  banner: "",
  section:
  ...
  btn: {
    ...
    delete:
      "bg-red-500 text-white hover:bg-red-600 active:bg-red-600 focus:bg-red-600",
    confirm:
      "bg-green-500 text-white hover:bg-green-600 active:bg-green-600 focus:bg-green-600",
    cancel:
      "bg-white text-gray-600  border-0 border-gray-600 hover:bg-gray-200",
    lessonStart:
      "bg-green-500 text-white hover:bg-green-600 active:bg-green-600 focus:bg-green-600",
    surveyStart:
