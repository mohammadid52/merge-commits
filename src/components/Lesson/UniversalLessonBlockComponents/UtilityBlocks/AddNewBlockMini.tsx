    ...
    <div className="relative">
      ...
      <div className="relative flex justify-center">
        <button
          ...
          type="button"
          className={`transition-all focus:scale-95 transform scale-100 duration-200  inline-flex w-auto items-center shadow-sm px-4 py-1.5   text-sm leading-5 font-medium rounded-full text-gray-600 dark:text-white dark:bg-gray-700 bg-gray-200 `}>
          <PlusSmIcon
