...
const Feedback = () => {
  ...
  return (
    <div className={`${theme.gradient.cardBase} bg-dark-blue w-full h-2.5/10 flex flex-col items-start rounded-lg text-gray-200 p-4 mb-4 border-l-8 border-green-light`}>
      ...
      <div className='h-4/10 w-full'>
        ...
        <textarea
          id='text'
          className='bg-gray-300 w-full p-2 text-md text-gray-800 rounded-lg '
