...
const Banner = () => {
    ...
    return (
        <div className="relative w-full h-1/10 flex flex-row justify-center items-center">
            ...
            <div className={`border-b border-white border-opacity-50 h-full w-full flex flex-row justify-center items-center text-5xl text-center font-open font-light ${theme.block.text} z-10`}>
                { title }
            </div>
        </div>
    )
