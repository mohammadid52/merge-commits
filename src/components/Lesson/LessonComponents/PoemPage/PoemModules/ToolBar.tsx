  ...
  return (
    <div className="w-full md:h-7/10 bg-grayscale-light flex flex-col items-center text-grayscale-lighter px-4 py-4 rounded-xl">
      <div className="w-full h-full flex flex-col justify-between">
        {/* <h3 className='w-full text-xl text-grayscale-lighter  font-light border-b-0 border-grayscale-lighter pb-1 mb-1'>
          Toolbox
        </h3>
        <h3 className='text-lg font-light '>My word bank:</h3>
        <div
          id='search'
        ...
        <div
          className={`${theme.elem.text} w-full h-40 md:h-6/10 text-2xl flex flex-col text-center justify-center font-light text-grayscale-lightest px-4 rounded-lg overflow-y-auto overflow-x-hidden`}>
          Toolbox coming soon...
        </div>
      </div>
    </div>
