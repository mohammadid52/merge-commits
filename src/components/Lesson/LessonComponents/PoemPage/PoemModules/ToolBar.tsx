...
const ToolBar = (props: ToolBarProps) => {
    ...
    return (
        <div className="w-full md:h-7/10 bg-gray-700 flex flex-col items-center text-gray-200 shadow-2 px-4 py-2 rounded-lg">
            <div className="mb-4 w-full h-full">
                ...
                <div className="w-full h-40 md:h-7/10 bg-gray-300 flex flex-col shadow-elem-dark text-gray-500 px-4 rounded-lg overflow-scroll">
                    { 
