    ...
    return (
        <div className="w-full h-full flex flex-row justify-center items-center">
            <div className="w-full h-full flex flex-col justify-between items-center">
                ...
                <div className="bg-dark-blue w-full h-112 md:h-7/10 p-8 flex flex-col items-center text-2xl text-gray-200 rounded-lg whitespace-pre-wrap overflow-y-auto overflow-x-hidden">
