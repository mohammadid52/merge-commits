...
const LyricsBlock = (props: LyricsBlockProps) => {
    ...
    return (
        <>
            <div className={`md:h-full relative bg-dark-blue ${fullscreen ? 'md:h-120' : 'h-68'} mb-4 md:mb-0 w-full pl-8 pr-4 py-4 flex flex-col justify-between rounded shadow-2 text-gray-400 text-lg`}>
                <div className="w-full flex flex-row justify-between">
                    <div className="w-9/10 flex flex-row justify-between border-b border-white mb-4 mr-4 md:mr-0">
                        <h3 className="w-auto text-2xl font-open border-b border-white mb-2">
                            Lyrics
                        </h3>
