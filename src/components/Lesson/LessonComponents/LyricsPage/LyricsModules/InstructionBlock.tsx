...
const InstructionsBlock = () => {
    ...
    return (
        <div className="md:h-5.5/10 bg-dark-blue w-full flex justify-center p-4 shadow-2 rounded-t text-gray-200">
            <div className="w-full flex flex-col items-center mr-4">
                <h3 className="text-xl font-open font-bold mb-3 border-b border-white mr-4">
                    Instructions
                </h3>
                {   !videoMode ?
