...
const ReflectionQuestions = () => {
    ...
    return (
        <div className="reflection w-full h-1.5/10 flex flex-row text-gray-200">
            <div className={`w-1/10 h-full flex justify-center items-center ${theme.gradient.cardBase} mr-2 md:mr-4 rounded-lg`} onClick={prevQuestion}>
            ...
            <div className={`w-1/10 h-full flex justify-center items-center ${theme.gradient.cardBase} ml-2 md:ml-4 rounded-lg`} onClick={nextQuestion}>
