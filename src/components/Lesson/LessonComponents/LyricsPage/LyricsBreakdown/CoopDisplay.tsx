  ...
  return (
    <div className='w-full h-full flex flex-col justify-between items-center'>
      ...
      <div className='h-7.2/10 w-full flex flex-col justify-between items-center'>
        ...
        <div
          className={`relative ${
            fullscreen ? 'h-full' : 'h-4.85/10'
          }  w-full rounded-lg border  bg-darker-blue p-4`}>
              ...
              ? teacherModules.map((module: any, key: number) => (
                  <div
                    ...
                    <div className='w-full flex flex-row justify-between items-center pb-2 border-b border-white border-opacity-10'>
                      <div
                        className={`${
                          fullscreen ? 'text-2xl w-10 h-10' : 'text-lg w-8 h-8'
                        } p-2 rounded-md bg-${
                          module.color
                        } flex justify-center items-center shadow-2`}>
                        {module.label}
                      </div>
                      <div
                        className={`${
