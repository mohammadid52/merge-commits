...
const StoryForm = () => {
    ...
    return (
        <div className="bg-gradient-to-tl from-dark-blue to-med-dark-blue w-full h-full px-4 md:px-8 py-4 flex flex-col text-dark-blue rounded-lg border-l-4 border-orange-600">
            <h3 className="text-xl text-gray-200 font-open font-light mb-4 pb-4 border-b border-white border-opacity-10">Story <span className="text-gray-600 font-light text-sm mr-4">(Fill in the form below!)</span></h3>
            <div className="h-full flex flex-col mb-5 mt-2">
                ...
                <input id="title" className="md:w-88 text-sm md:text-xl px-4 py-2 mb-4 rounded-lg text-gray-700 bg-gray-300" name="title" type="text" placeholder="La Llorona" value={input.title} onChange={handleInputChange}/>
                <textarea id="story" className="w-full h-9/10 text-sm md:text-xl p-4 rounded-lg text-gray-700 bg-gray-300" name="story" placeholder="Write your story here!" value={input.story} onChange={handleInputChange}/>
            </div>
        </div>
    )
}
