    ...
    return (
        <div className="bg-dark-blue w-full h-full px-4 md:px-8 py-4 flex flex-col text-gray-200 shadow-2 rounded-sm">
            ...
            <div className="flex flex-col mb-5 mt-2">
                ...
                <textarea id="story" className="w-full h-64 md:h-80 text-sm md:text-xl p-4 rounded shadow-2 text-gray-700 bg-gray-300" name="story" placeholder="Write your story here!" value={input.story} onChange={handleInputChange}/>
            </div>
        </div>
    )
}
