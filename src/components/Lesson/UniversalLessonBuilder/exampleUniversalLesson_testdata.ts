...
const exampleFetch: UniversalLesson = {
  ...
  summary: 'This is the first lesson created with the universal lesson builder!',
      ...
      pageContent: [
        {
          ...
          partType: 'default',
          class: 'grid grid-cols-1 gap-2',
          partContent: [{ id: 'abc', content: '<p>Hello World</p>' }],
        },
      ],
    },
    {
      ...
      pageContent: [
        {
          ...
          partContent: [
            ...
            {
              id: 'abc',
              content: '<img src="https://www.google.com/image.jpg" alt=""/>',
            },
          ],
        },
      ],
      ...
      pageContent: [
        {
          ...
          partType: 'default',
          class: '',
          partContent: [{ id: 'abc', content: '<span>Top left...</span>' }],
        },
        {
          id: 'page_3_part_2',
          partType: 'default',
          class: '',
          partContent: [{ id: 'abc', content: '<span>Center top...</span>' }],
        },
        {
          id: 'page_3_part_3',
          partType: 'default',
          class: '',
          partContent: [{ id: 'abc', content: '<span>Top right...</span>' }],
        },
        {
          id: 'page_3_part_4',
          partType: 'default',
          class: '',
          partContent: [{ id: 'abc', content: '<span>Mid Left...</span>' }],
        },
        {
          id: 'page_3_part_5',
          partType: 'default',
          class: 'grid grid-cols-2 gap-2',
          partContent: [
            { id: 'abc', content: '<span>Mid center L...</span>' },
            { id: 'abc', content: '<span>Mid center R...</span>' },
          ],
        },
      ],
    },
