  ...
  return (
    <div>
      ...
      selectedPageDetails.pageContent.length > 0 ? (
        [
          selectedPageDetails.pageContent.map(
            (pagePart: PagePart, idx: number): any => (
              // ONE ROW
              <div
                ...
                className={`relative ${
                  ...
                  !selectedComponent?.partContentID
                    ? `opacity-${
                        pagePart.id === selectedComponent?.pageContentID
                          ? "100"
                          : "50"
                      } `
                    : ""
                          ...
                          (content: PartContent, idx2: number) => (
                            ...
                            >
                              <EditOverlayBlock
                                ...
                                isComponent={true}
                                isLast={
                                  idx2 === pagePart.partContent?.length - 1
                                }
                                handleEditBlockToggle={() =>
