    ...
    <div>
      <div className="mt-1 relative rounded-md shadow-sm">
        <input
          ...
          onChange={onChange}
          id={id}
          className={`${whenError} block w-full dark:text-white dark:bg-gray-800 shadow-sm sm:text-sm focus:ring-indigo-500 focus:border-indigo-500 dark:border-gray-700 border-gray-300 rounded-md`}
