...
const LessonLoading = () => {
  ...
  return (
    <div className="min-h-screen h-screen w-full bg-dark-gray text-gray-200  font-light flex flex-col justify-center items-center">
      <div className="relative w-full mb-4 pb-4 flex flex-col justify-center items-center rounded-lg animate-fadeIn">
        <div
          ...
          <img src={getAsset(clientKey, 'loading_logo')} alt="Logo" />
        </div>
        <div
