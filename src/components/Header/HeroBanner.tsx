  ...
  return (
    <div className="relative">
      ...
      <div className="relative h-full flex items-center justify-center flex-col max-w-7xl">
        <h1
          // style={{fontSize: '6rem'}}
          className={`z-0 flex align-center self-auto items-center justify-center h-32 2xl:h-60 font-extrabold tracking-tight text-center text-white text-2xl 2xl:text-6xl pb-8 2xl:pb-6 ${
