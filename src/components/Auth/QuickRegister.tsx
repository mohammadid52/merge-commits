          ...
          <span className='w-full flex inline-flex rounded-xl shadow-sm'>
            {
                waiting ?
                    (<button
                        className=' bg-light-gray bg-opacity-20 text-white  inline-flex justify-center w-full rounded-xl border border-transparent px-4 py-2 mt-2 text-base leading-6 font-medium shadow-sm focus:outline-none transition ease-in-out duration-150 sm:text-sm sm:leading-5'>
                        Registering...
                    </button>)
                    : (<button
                        type='submit'
                    ...
                    <p className={'mt-2 text-xs text-center'}>
                        The students will receive an e-mail to confirm their registration (please ask them
