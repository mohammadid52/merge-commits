...
const Privacy = () => {
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-center">
      <div
        className={`w-full h-.7/10 md:h-12 theme-bg text-lightest flex justify-center md:justify-end`}>
        <div
          className={`w-full h-full md:h-12 theme-bg flex text-2xl font-bold z-50 ml-4`}>
      ...
      <div className="h-9.5/10 py-8 px-28">
        ...
        <div className="text-2xl font-bold pb-4">Interpretation and Definitions</div>
        ...
        <ul className="list-disc p-4 mx-6">
          ...
          <li className="pb-2">
            ...
            Agreement) refers to Project Curate, 11140 Greenbay St, Houston, TX 77024,
            United States. For the purpose of the GDPR, the Company is the Data
            Controller.
          </li>

          <li className="pb-2">
            Application means the software program provided by the Company downloaded by
            You on any electronic device, named Iconoclast Artists
          </li>
          <li className="pb-2">
          ...
          <li className="pb-2">
            Facebook Fan Page is a public profile named SEL Ready specifically created by
            the Company on the Facebook social network, accessible from
            https://facebook.com/selready
          </li>
          <li className="pb-2">
          ...
          <li className="pb-2">
            ...
            a natural person who is a California resident. A resident, as defined in the
        ...
        <div className="pb-2">
          ...
          and/or a Service Provider's server or it be simply stored on Your device.
        </div>
        ...
        <div className="text-xl font-bold pb-4">Tracking Technologies and Cookies</div>
        <div className="pb-2">
        ...
        <ul className="list-disc p-4 mx-6">
          ...
          <li className="pb-2">
            <div className="pb-2">Cookies Policy / Notice Acceptance Cookies</div>
        ...
        <ul className="list-disc p-4 mx-6">
          <li className="pb-2">
            ...
            You, to advertise on third party websites to You after You visited our Service
        ...
        <div className="text-xl font-bold pb-4">Retention of Your Personal Data</div>
        <div className="pb-2">
        ...
        <div className="text-xl font-bold pb-4">Transfer of Your Personal Data</div>
        <div className="pb-2">
        ...
        <div className="text-xl font-bold pb-4">Disclosure of Your Personal Data</div>
        ...
        <div className="text-xl font-bold pb-4">Security of Your Personal Data</div>
        <div className="pb-2">
        ...
        <ul className="list-disc p-4 mx-6">
          <li className="pb-2">
            ...
            the information We have on You. Whenever made possible, you can access, update
            or request deletion of Your Personal Data directly within Your account
          ...
          <li className="pb-2">
            ...
            right to to have any incomplete or inaccurate information We hold about You
            corrected.
          </li>
          <li className="pb-2">
        ...
        <div className="pb-2">
          ...
          (https://facebook.com/selready), the Company and the operator of the social
          network Facebook are Joint Controllers.
        </div>

        <div className="pb-2">
          The Company has entered into agreements with Facebook that define the terms for
          use of the Facebook Fan Page, among other things. These terms are mostly based
          on the Facebook Terms of Service: https://www.facebook.com/terms.php
        </div>
        ...
        <div className="pb-2">
          ...
          or by mail: Facebook, Inc. ATTN, Privacy Operations, 1601 Willow Road, Menlo
        ...
        <div className="pb-2">
          ...
          Our Facebook Fan Page. Each Cookie contains a unique identifier code and remains
          active for a period of two years, except when it is deleted before the end of
          this period.
        </div>
        ...
        <ul className="list-disc p-4 mx-6">
          ...
          <li className="pb-2">
            The right to access / the right to request. The CCPA permits You to request
          ...
          <li className="pb-2">
            The right to say no to the sale of Personal Data. You also have the right to
            ask the Company not to sell Your Personal Data to third parties. You can
            submit such a request by visiting our "Do Not Sell My Personal Information"
            section or web page.
          </li>
          <li className="pb-2">
          ...
          <li className="pb-2">
            ...
            deletion of Your Personal Data that have been collected in the past 12 months.
          </li>
          <li className="pb-2">
        ...
        <div className="text-xl font-bold pb-4">Do Not Sell My Personal Information</div>
        <div className="pb-2">
        ...
        <ul className="list-disc p-4 mx-6">
          ...
          <li className="pb-2">Or from Our "Do Not Sell My Personal Information" link</li>
        </ul>
        <div className="pb-2">
        ...
        <div className="pb-2">Our Service does not respond to Do Not Track signals.</div>
        ...
        <div className="pb-2">
          The Service may contain content appropriate for children under the age of 13. As
          a parent, you should know that through the Service children under the age of 13
          may participate in activities that involve the collection or use of personal
        ...
        <div className="pb-2">
          ...
          "Types of Data Collected" section of this Privacy Policy. We follow our standard
          Privacy Policy for the disclosure of personal information collected from and
          about children.
        </div>
        ...
        <div className="text-2xl font-bold pb-4">
          Your California Privacy Rights (California Business and Professions Code Section
          22581)
        </div>
        <div className="pb-2">
        ...
        <div className="text-2xl font-bold pb-4">Changes to this Privacy Policy</div>
        <div className="pb-2">
        ...
        <ul className="list-disc p-4 mx-6">
          ...
          <li className="pb-2">
            By visiting this page on our website: https://iconoclastartists.org/
          </li>
        </ul>
      </div>
    </div>
