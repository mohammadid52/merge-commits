...
const DownloadCSV = (props: DownloadCSV) => {
    ...
    const onClassroomSelect = async (classroom: { id: string, name: string, value: string }) => {
    ...
    useEffect(() => {
        if (selectedClassroom) {
            let selectedInstituteClassroom = selectedInstituteClassrooms.filter((cr: any) => cr.id === selectedClassroom.id)[0];
            let sClass: { id: string, name: string } = { id: selectedInstituteClassroom.class.id, name: selectedInstituteClassroom.class.name };
            let sCurriculum: { id: string, name: string } = { id: selectedInstituteClassroom.curriculum.id, name: selectedInstituteClassroom.curriculum.name };
