...
const ModalFill: React.FC<ModalProps> = (modalProps: ModalProps) => {
  const {
    showHeader,
    title,
    showHeaderBorder,
  ...
  return (
    <>
      ...
      <div
        ...
        className={
          'fixed modal transition-all duration-500 show justify-center items-center flex overflow-hidden inset-0 z-50 outline-none focus:outline-none'
        }>
        <div
          onClick={(e) => {
            if (closeOnBackdrop) {
