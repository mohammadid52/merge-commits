...
const BreadcrumbsWithBanner: React.FC<BreadCrumbProps> = (
  ...
  const { state, theme, userLanguage, dispatch, clientKey } =
    useGlobalContext();
  ...
  return (
    <>
      <div className="relative">
        ...
        <div
          className={`absolute ${theme.backGround[themeColor]} bottom-0 z-20`}
        >
          <div
            className={`${
