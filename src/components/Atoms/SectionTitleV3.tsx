...
const SectionTitleV3: React.FC<SectionTitleProps> = (
  ...
  return (
    ...
    >
      <div className={`${textWidth}`}>
        {title && (
          <h2
            className={`text-lg 2xl:text-${fontSize} font-${fontStyle} ${extraClass}`}
          >
            {title}
          </h2>
        )}
        ...
        {subtitle && (
          <p className="text-sm mt-2 md:mt-0 2xl:text-base text-gray-500">
            {subtitle}
          </p>
        )}
      </div>
