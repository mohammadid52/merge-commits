  ...
  return (
    ...
    >
      ...
      <div className="w-1.5/10 flex items-center px-8 py-4 whitespace-normal text-sm leading-5 text-gray-500">
        <span className="w-auto">{label ? label : "--"}</span>
      </div>
      ...
      <div
        className="w-1/10 flex justify-center items-center pr-4 py-4 cursor-pointer whitespace-nowrap text-indigo-600 hover:text-indigo-900 text-sm leading-5 font-medium"
        onClick={handleQuestionEdit}
      >
