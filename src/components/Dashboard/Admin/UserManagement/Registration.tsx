...
const Registration = ({
  ...
  const createStaffMutation = useGraphqlMutation<
  ...
  const listAllRooms = async (
    ...
    try {
      ...
      setInstClasses(
        combined.map((d: any) => ({ ...d, value: d.classID, roomId: d.id }))
      );
                  ...
                  <div className="grid grid-cols-1 gap-y-4 gap-x-4 sm:grid-cols-6">
                    <div className="sm:col-span-3 p-2">
                      <FormInput
                        ...
                        placeHolder={
                          RegistrationDict[userLanguage]["firstplaceholder"]
                        }
                      />
                    </div>
                    ...
                    <div className="sm:col-span-3 p-2">
                      <FormInput
                        ...
                        placeHolder={
                          RegistrationDict[userLanguage]["lastplaceholder"]
                        }
                      />
                    </div>
                    ...
                    <div className="sm:col-span-3 p-2">
                      <FormInput
                        ...
                        onChange={handleChange}
                        placeHolder={
                          RegistrationDict[userLanguage]["emailplaceholder"]
                        }
                      />
                    </div>
                    ...
                    {checkIfAdmin() && (
                      <div className="sm:col-span-6">
                        <CheckBox
                          ...
                          value={values.isZoiq}
                          onChange={(e) =>
                            setFieldValue("isZoiq", e.target.checked)
                          }
                          name="isZoiq"
                        />
                      </div>
                        ...
                        <div className="sm:col-span-3 p-2">
                          <div>
                            ...
                            <CheckBox
                              dataCy="self-paced"
                              label={
                                RegistrationDict[userLanguage]["paceCheckBox"]
                              }
                              className="group:hover:bg-gray-500"
