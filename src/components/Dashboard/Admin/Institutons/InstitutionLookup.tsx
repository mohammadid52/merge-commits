      ...
      <div className={`w-full h-full`}>
        ...
        <div className="flex justify-between">
          ...
          <div className="flex justify-end py-4 mb-4">
            ...
            <Selector placeholder={InstitutionDict[userLanguage]['SORTBY']} list={sortByList} selectedItem={sortingType.name} onChange={setSortingValue} btnClass="rounded-r-none  border-r-0 " arrowHidden={true} />
