      ...
      <div className="px-4 py-5 border-b-0 border-gray-200 sm:px-6 flex items-center">
        ...
        <h4 className="text-base leading-6 font-medium text-gray-900 flex items-center">
          ...
          <span className="font-normal text-gray-600 w-auto flex-shrink-0">
            {CheckpointLookupDict[userLanguage]['PREVIOUSCHECKPOINT']}
          </span>
        </h4>
      </div>
        ...
        <div className="flex mt-8 justify-center px-6 pb-4">
          <div className="flex justify-center my-6">
            <Buttons
              ...
              label={CheckpointLookupDict[userLanguage]['BUTTON']['CANCEL']}
              onClick={() => changeStep('SelectedCheckPointsList')}
              transparent
            />
            <Buttons
              ...
              label={
                saving
                  ? CheckpointLookupDict[userLanguage]['BUTTON']['SAVING']
                  : CheckpointLookupDict[userLanguage]['BUTTON']['SAVE']
              }
              onClick={() => {
                setSaving(true);
                onSave(selectedCheckpointIds);
              }}
            />
          </div>
        </div>
