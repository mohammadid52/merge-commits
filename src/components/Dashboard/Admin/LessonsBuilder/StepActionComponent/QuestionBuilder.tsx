    ...
    <div className="bg-white shadow-5 overflow-hidden sm:rounded-lg mb-4">
      <div className="px-4 py-5 border-b-0 border-gray-200 sm:px-6">
        <h3 className="text-lg leading-6 font-medium text-gray-900">
          {' '}
          {QuestionBuilderDict[userLanguage]['HEADING']}{' '}
        </h3>
      </div>
      ...
      <div className="p-4">
        <div className="flex justify-between">
          <p className="text-sm text-gray-500 flex items-center px-4">
            {QuestionBuilderDict[userLanguage]['NOTE']}
          </p>
          <Buttons
            label="Add New Question"
            onClick={toggleModal}
            btnClass="px-4 py-4 w-1/4"
          />
        </div>
        <div>
                          ...
                          <div
                            ...
                            <div
                              ...
                              <div className="flex w-3/10 px-8 py-3 items-center text-left text-s leading-4 font-medium whitespace-normal">
                                {' '}
                                {QuestionBuilderDict[userLanguage]['WHERARE']}{' '}
                              </div>
                              <div className="flex w-2/10 px-8 py-3 text-left text-s leading-4 items-center whitespace-normal">
                                {QuestionBuilderDict[userLanguage]['WHERYOU']}
                              </div>
                              <div className="flex w-2/10 px-8 py-3 text-left text-s leading-4 items-center whitespace-normal">
                                {QuestionBuilderDict[userLanguage]['TEXTINPUT']}
                              </div>
                              <div className="flex w-2/10 px-8 py-3 text-left text-s leading-4 items-center">
                                ...
                                <span
                                  className={`w-auto cursor-pointer ${theme.textColor[themeColor]}`}>
                                  <IconContext.Provider
                                    value={{size: '1.5rem', color: '#B22222'}}>
                                    <FaTrashAlt />
                                  </IconContext.Provider>
                                </span>
                              </div>
