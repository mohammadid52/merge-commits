...
const AddQuestionModal = (props: AddQuestionModalProps) => {
  ...
  const {AddQuestionModalDict} = useDictionary(clientKey);
  ...
  return (
    <Modal
      showHeader={true}
      title={AddQuestionModalDict[userLanguage]['TITLE']}
      showHeaderBorder={true}
      showFooter={false}
      closeAction={closeAction}>
      <div className="">
        <a
          className="text-sm text-indigo-600 px-6 cursor-pointer"
          onClick={() => setActiveStep('Previously Used Questions')}>
          {AddQuestionModalDict[userLanguage]['HEADING']}
        </a>
        <div className="grid grid-cols-2 min-w-256 py-4">
          <div className="px-6">
            <TextArea
              ...
              name="question"
              label={AddQuestionModalDict[userLanguage]['QUESTION']}
              isRequired
            />
          </div>
          <div className="px-6">
            <TextArea
              ...
              onChange={onInputChange}
              name="notes"
              label={AddQuestionModalDict[userLanguage]['NOTELABEL']}
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 min-w-256 py-4">
          <div className="px-6">
            <FormInput
              ...
              onChange={onInputChange}
              name="label"
              label={AddQuestionModalDict[userLanguage]['QUESTIONLABEL']}
              isRequired
            />
          </div>
          ...
          <div className="px-6">
            ...
            <Selector
              selectedItem={''}
              placeholder={AddQuestionModalDict[userLanguage]['LANGUAGE']}
              list={languageList}
        ...
        <div className="grid grid-cols-2 min-w-256 py-4">
          <div className="px-6">
            ...
            <Selector
              ...
              placeholder={AddQuestionModalDict[userLanguage]['TYPE']}
              list={typeList}
          ...
          <div className="px-6 flex items-center">
            <CheckBox
              ...
              name="isRequired"
              label={AddQuestionModalDict[userLanguage]['MAKEQUESTIONREQUIRED']}
            />
          </div>
        </div>
          ...
          <div className="p-6">
            <div className="p-6 border-gray-400 border">
              <p className="text-m font-medium leading-5 text-gray-700 mb-1">
                {AddQuestionModalDict[userLanguage]['ADDOPTION']}{' '}
              </p>
              ...
              <div className="flex w-9/10 mx-auto mt-4">
                <div className="w-2/4 flex items-center">
                  <CheckBox
                    ...
                    onChange={() => console.log('onChange')}
                    name="otherOpt"
                    label={AddQuestionModalDict[userLanguage]['ADDOTHEROPTION']}
                  />
                </div>
                <div className="w-2/4 flex items-center">
                  <CheckBox
                    ...
                    onChange={() => console.log('onChange')}
                    name="isRequired"
                    label={AddQuestionModalDict[userLanguage]['ADDNOTEABOVE']}
                  />
                </div>
              </div>
            </div>
        ...
        <div className="flex mt-8 justify-center px-6 pb-4">
          <div className="">
            <Buttons
              btnClass="py-1 px-2 text-xs ml-4"
              label={AddQuestionModalDict[userLanguage]['BUTTON']['NEXT']}
              onClick={saveAction}
