...
const LessonsListRow = (props: LessonsListRow) => {
  ...
  return (
    <div
      ...
      <div
        className="w-3/10 capitalize flex items-center px-8 py-4 hover:text-gray-600 cursor-pointer text-sm leading-5 font-medium text-gray-900 whitespace-normal"
