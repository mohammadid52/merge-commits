...
const HeaderTextBar = ({children}: {children: ReactNode}) => {
  return (
    <div
      className={`w-full max-w-88 lg:max-w-192 md:max-w-96 2xl:max-w-256 mx-auto  z-10 flex flex-col justify-between  items-center -mt-4 2xl:-mt-6 mb-4 px-6 2xl:py-4 m-auto relative
