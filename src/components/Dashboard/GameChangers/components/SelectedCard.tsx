...
const SelectedCard = ({
  ...
  const showSelectors =
    !isCompleted && (selectedCard === 0 || selectedCard === 1);

  return (
    <ErrorBoundary componentName="SelectedCard">
      <div
        className={`${
          inLesson ? "border-0 border-gray-700" : ""
        } rounded-2xl box ${
          inLesson ? "" : "m-8"
      ...
      >
        ...
        >
          <div>
            <AnimatedContainer
              show={selected && selected?.type === THINK_ABOUT_IT}
            >
              {selected && selected?.type === THINK_ABOUT_IT && (
                <ThinkAboutItCard />
              )}
            </AnimatedContainer>
            ...
            <AnimatedContainer
              show={selected && selected?.type === SINGING_BOWL}
            >
            ...
            >
              {showSelectors && countSelected === null && (
                <>
                  <h1 className="text-4xl my-4  text-white font-bold">
                    {card?.title}
                  </h1>
              ...
              {isCompleted && (
                <>
                  ...
                  <p className="text-base my-4  text-gray-100 font-light max-w-72 transition-all text-left">
                    ...
                    <br /> Come back anytime when you want to feel more focused
                    and centered during your day.
                  </p>
                  <button
                    onClick={() => {
                      onClick(null);
      ...
      {selectedCard === 3 &&
        selectedEmotions &&
        selectedEmotions?.length > 0 && <SelectedEmotionsContainer />}
    </ErrorBoundary>
  );
};
