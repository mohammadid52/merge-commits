...
function Dropdown() {
  ...
  return (
    ...
    <button className="w-auto" onClick={ handleLink } >
    ...
    <div className="absolute z-50 mt-10 w-56 rounded-md shadow-lg">
        ...
        <div className="py-1">
            ...
            <a href="#" className="group flex items-center px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900" role="menuitem" onClick={lightSwitch}>
            <svg className="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-500" viewBox="0 0 20 20" fill="currentColor">
