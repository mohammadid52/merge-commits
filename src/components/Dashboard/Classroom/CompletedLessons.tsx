              ...
              <div className={`relative bg-white rounded-xl shadow-container ${theme.elem.text} h-auto flex mb-8`}>
                <div
                  ...
                  style={{
                    backgroundImage: `linear-gradient(to top, rgba(0, 0, 0, 0.52), rgba(0, 0, 0, 0), rgba(0, 0, 0, 0)),url(${
                      value && value.lesson.artist.images ? value.lesson.artist.images : null
                    })`,
                  ...
                  <div className="h-3/10 flex flex-row-reverse">
                    <h2
                      ...
                      style={{ textShadow: '1px 1px black' }}>
                      {value && value.lesson.artist.name ? value.lesson.artist.name : null}
                    </h2>
                  </div>
                </div>
                <div className="w-7.5/10 flex flex-col ">
                  <div className="h-44 p-4 flex flex-col justify-start items-center">
                    ...
                    <p className="text-sm text-left">{value && value.lesson.summary ? value.lesson.summary : null}</p>
                  </div>
                  <div className={`h-2/10 ${theme.dashboard.bg} flex justify-between text-sm  rounded-br-xl`}>
                    ...
                    <div className="flex w-3.3/10">
                      <Start
                        lessonKey={value ? value.lessonID : null}
