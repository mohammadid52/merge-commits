                ...
                <div className="w-7.5/10 flex flex-col ">
                    <div className="h-8.7/10 px-12 py-4 flex flex-col justify-center items-center">
                        ...
                        <p className="text-md text-center py-4">
                            This is a quick survey that you'll take just to see where you're at in terms of some of the topics we'll cover over this course. Please take the next few minutes to finish this survey as thoughtfully as you can. We appreciate your participation, and we're excited to get excited on this Iconoclast journey with you!
                        </p>
