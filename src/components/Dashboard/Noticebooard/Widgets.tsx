...
export const mobileShowClass =
  "xs:inline-block md:inline-block lg:hidden xl:hidden";
...
export const LogoWidget = (props: {
  ...
  const { source, altdesc, title } = props;
  return (
...
export const ImageWidget = (props: {
  ...
  return (
    <div
      className={`p-2 mb-4 bg-white  border-0 border-dark-gray border-opacity-10`}
    >
      {title && (
        <p
...
export const DefaultTextWidget = (props: {
  ...
  return (
    <div className="p-2 bg-white shadow rounded-lg">
      <p
        className={`text-sm p-2 font-semibold border-b-0 text-gray-900 border-gray-200`}
      >
        {title}
      </p>
