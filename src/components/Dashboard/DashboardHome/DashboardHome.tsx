                    ...
                    <div className="w-full h-full rounded-lg flex flex-row">
                        <div className="w-1/2 flex flex-col mr-2 justify-between">
                            <div className="w-full flex justify-between flex-grow">
                                <div className="now bg-white shadow-elem-light mb-2 rounded-lg flex-col justify-center items-center p-4">
                            ...
                            <div className="w-full flex justify-between flex-grow">
                                <div className="now bg-white shadow-elem-light rounded-lg flex-col justify-center items-center p-4">
                                    <IconContext.Provider value={{ size: '3rem', color: '#1C2C42' }}>
                                        <BsCalendarFill />
                                    </IconContext.Provider>
                            ...
                            <div className="flex-grow h-full bg-white shadow-elem-light text-2xl text-center rounded-lg ml-2 p-4 flex flex-col justify-center content-center">    
