...
const Banner = (props: BannerProps) => {
    ...
    return (
        <div className="w-full h-1/10 flex flex-row justify-center items-center">
            ...
            <div className={`${fullscreen ? 'text-4xl' : 'text-3xl px-4 py-2'} h-full bg-dark-blue w-full flex flex-row justify-center items-center text-center font-open font-bold text-gray-200 rounded-lg shadow-2 z-10`}>
                    { title }
            </div>
        </div>
    )
