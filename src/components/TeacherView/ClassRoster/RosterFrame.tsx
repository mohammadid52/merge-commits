  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          display:
            breakpoint === "xl" || breakpoint === "2xl" ? "block" : "none",
        }}
      >
        <LessonDetails
          rightView={rightView}
        ...
        />
        <div
          className={`h-full w-full flex flex-col justify-between items-center z-100`}
        >
      ...
      <div
        ...
        style={{
          width: "36px",
          display:
            breakpoint === "xl" || breakpoint === "2xl" ? "none" : "block",
        }}
      >
        <ButtonsRound
