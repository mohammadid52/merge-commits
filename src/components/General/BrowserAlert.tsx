...
const BrowserAlert = (props: any) => {
  ...
  const { setVisible } = useOutsideAlerter(false);
          ...
          <div className="px-2 pt-2">
            ...
            <div>
              <div className="mx-auto flex items-center justify-center rounded-full">
                ...
                <div className="ml-2 text-lg text-white w-auto">
                  Safari Users
                </div>
              </div>
              {/* MAIN CONTENT */}
              <div className={`mt-3 text-center sm:mt-5 text-white`}>
                <h3
                  ...
                  id="modal-headline"
                >
                  For optimal experience, we suggest logging in Chrome, Firefox,
                  or MS Edge. Using Safari is not recommended at this time.
                </h3>
                <div>
                  <button
                    type="button"
