...
const dropdownDetail = {
  button: 'Community Manager',
  item: 'Community-Builder-item',
  item2: 'Front-page-item'
};
...
describe('Navbar flow', () => {
  ...
  it(
    'Use Navbar Links for Community Manager',
